...
void solve(){
    ...
    fn(i, n){
        ...
        else if(issrc and indeg[i]+1 == outdeg[i])issrc=false;
        else if(isdest and indeg[i]==outdeg[i]+1)isdest=false;
        else{
            cout<<"eulerian path not present"<<endl;return;
        }
    }
    cout<<"eulerian path present"<<endl;
}
int main()
{
 fast_cin();
